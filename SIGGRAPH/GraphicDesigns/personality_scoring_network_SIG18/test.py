...
print(original_img_size) # (_, 300, 200, 3) row, col, channel
input_a = Input(batch_shape=(None,) + original_img_size) # (_, 300, 200, 3) row, col, channel
input_b = Input(batch_shape=(None,) + original_img_size)
input_personality = Input(shape=(opt.number_of_personalities,)) #  Tensor("input_3:0", shape=(?, 15), dtype=float32)
