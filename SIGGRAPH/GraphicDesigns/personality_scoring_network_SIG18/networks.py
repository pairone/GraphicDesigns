...
def create_design_feature_network(img_chns,output_dim,img_width,img_height,dropout_rate,w_regularizer,batch_norm_flag):
    ...
    if dropout_rate[0]!=-1:
        ...
        model_feature.add(Convolution2D(64, 3, 3,input_shape=(img_chns, img_width, img_height), border_mode='same',
                                    activation='relu',W_regularizer=l2(w_regularizer), name='feature_conv1_1'))
    model_feature.add(MaxPooling2D((4, 4),name='feature_maxpool1_2', dim_ordering="th"))
    if dropout_rate[2]!=-1:
    ...
    model_feature.add(MaxPooling2D((4, 4), name='feature_maxpool2', dim_ordering="th"))
    if dropout_rate[4]!=-1:
    ...
    model_feature.add(MaxPooling2D((4, 4), name='feature_maxpool3',dim_ordering="th"))
    if dropout_rate[6]!=-1:
